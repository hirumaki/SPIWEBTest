export const problems = [
    ...
    },
    {
      ...
      \n\n昔話の教訓には、日本にあることわざに似たような意味になるものが存在する。（ア）これは、裏で多くの人々が同じ様な経験をしたことに由来するのではないだろうか。（イ）先人の間違いや経験を、風刺する形で分かりやすく表していることが、昔話は優れている。（ウ）一方、直接的な言葉で表現している分、ことわざは表現しやすい。（エ）既に分別がついている大人に格言として残すか、まだ幼い子どもに伝える為に物語にするかが、先人によって分かれ、同じような意味をながら、違う形で表現されている。どちらも、【　】という点では同じ意味を持つ為、その場その場での使い方を工夫することが、私たちはできるのである。
      `,
      statement:'',
      choices:[1,2,3,4,5],
      solution:[2,4]
